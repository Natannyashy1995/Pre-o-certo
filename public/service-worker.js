...
self.addEventListener('activate', event => {
  event.waitUntil(
    caches.keys().then(keys =>
      ...
      console.log('[SW] v3 ativo — cache antigo limpo');
...
self.addEventListener('fetch', event => {
  ...
  // ── App Shell (HTML principal): SEMPRE da rede, NUNCA do cache ─
  // Garante que o Safari iOS sempre carregue a versão mais recente
